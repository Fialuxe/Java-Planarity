...
public class PlanarityGame extends JFrame {
    ...
    private JPanel createTopPanel() {
        ...
        difficultyLabel.setFont(new Font("Meiryo", Font.BOLD, 13));
        panel.add(difficultyLabel);

        difficultySelector = new JComboBox<>(LanguageManager.getDifficultyOptions());
        difficultySelector.setFont(new Font("Meiryo", Font.PLAIN, 12));
    ...
    private JButton createStyledButton(String text, Color color) {
        ...
        button.setFont(new Font("Meiryo", Font.BOLD, 12));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            // Generate initial graph after window layout is complete
            SwingUtilities.invokeLater(() -> game.generateGraph(6));
        });
    }
}
